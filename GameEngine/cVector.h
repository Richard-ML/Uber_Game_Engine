...
*                                                                              /____/
//===-- cVector.h - cVector --------------------------------------*- C++ -*-===//
Description: Smart container with contiguous memory. 
NOTE: Inserting at end is fast, anywhere else is slow
Quick to access any location (“lookup”)
...
*/
class cVector {
	unsigned int capacity; // Number of elements that currently allocated memory can hold..
	unsigned int size; // Current number of elements in the array
